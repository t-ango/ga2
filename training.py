...
#removed other agents for simplicity
'''
# run on cpu
import os
...
from agent import DeepQLearningAgent #removed extra imports
import json
...
agent_type = "DeepQLearningAgent" #removed checks for deleted agents
...
decay = 0.97
if(supervised): #in case still used
    try:
